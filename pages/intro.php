...
<head>
  ...
  <link rel="preload" href="/Biblioteca-Andromeda/assets/audio/Gravity_s_Maw.mp3" as="audio" type="audio/mpeg">
  <link rel="stylesheet" href="/Biblioteca-Andromeda/assets/css/introducao.css">
</head>
<body>
  ...
  <audio
    id="intro-music"
    src="/Biblioteca-Andromeda/assets/audio/Gravity_s_Maw.mp3"
    preload="auto"
    playsinline
  ></audio>
  ...
  <main id="ui-layer">
    ...
    >
      ...
      <!-- Botão -->
      <a
        href="/Biblioteca-Andromeda/login"
        class="btn-entrar"
        id="btn-despertar"
        role="button"
        data-next="/Biblioteca-Andromeda/login"
        data-audio="/Biblioteca-Andromeda/assets/audio/Gravity_s_Maw.mp3"
  ...
  <script src="/Biblioteca-Andromeda/assets/js/intro.js"></script>
