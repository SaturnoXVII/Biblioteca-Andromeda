...
if (isset($_POST['email'])) {
    ...
    $mysqli->query("INSERT INTO  usuarios (username, nome, sobrenome, email, data_nascimento, telefone, endereco, nivel_acesso, senha) VALUES ('$username','$nome', '$sobrenome', '$email', '$nascimento', '$telefone', '$endereco', '$nivel_acesso', '$senha')");
}
    ...
    <section class="container text-center my-4" id="Cadastro">
        ...
        <div class="formulario card shadow border-0 rounded-4  p-4 m-4 mt-3 ">
            ...
            <form class="d-grid gap-3" method="POST" action="">
                ...
                <input type="text" name="data_nascimento" class="form-control" placeholder="Data de nascimento">
