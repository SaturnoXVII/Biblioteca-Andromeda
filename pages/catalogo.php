        ...
        <div class="perfil-user-info d-flex align-items-center w-100">
            ...
            <div class="perfil-user-details ms-3">
                ...
                <div class="perfil-user-meta">
                    @<?= $h($usuario['username']) ?> <span class="mx-2">·</span> <?= $h($usuario['nivel_acesso']) ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="tab-pane fade" id="tab-emprestimos">
            <?php if (empty($emprestimos)): ?>
                <div class="form-card text-center py-5">
                    <i class="fa-solid fa-satellite-dish mb-4" style="font-size: 3rem; color: var(--border-hairline);"></i>
                    <p class="text-muted text-uppercase" style="font-family: var(--font-mono); letter-spacing: 1px; margin-bottom: 0;">
                            ...
                            <tbody>
                                <?php foreach ($emprestimos as $emp): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-semibold" style="color: var(--am3); font-size: 1rem;"><?= $h($emp['titulo']) ?></td>
                                        ...
                                        <td class="pe-4">
                                            <span class="<?= $st['class'] ?> fw-semibold" style="font-family: var(--font-mono); font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px;">
